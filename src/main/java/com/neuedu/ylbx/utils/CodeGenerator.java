...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\大合集\\东软颐养中心\\01.源代码\\服务端\\yyzx\\src\\main\\java");
        gc.setAuthor("wyh");// 设置作者名字
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/yyzx? useUnicode=true&characterEncoding=UTF8&useSSL=false&serverTimezone=GMT%2B8");
...
// pc.setModuleName(scanner("模块名"));
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return   "D:\\大合集\\东软颐养中心\\01.源代码\\服务端\\yyzx\\src\\main\\resources\\mapper" + pc.getModuleName()
